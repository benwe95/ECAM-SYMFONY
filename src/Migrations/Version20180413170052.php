 ...
 */
class Version20180413170052 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE category_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE category_id category_id INT NOT NULL');
    }
}
